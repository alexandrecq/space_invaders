...
static const Array4f INTERFACE_CLEAR_COLOR = {0.15f, 0.05f, 0.20f, 1.f};
static const Array4f INTERFACE_BOTTOM_COLOR = {.1f, .5f, .2f, 1.f};
static const float INTERFACE_OVERLAY_ALPHA = .9f;
